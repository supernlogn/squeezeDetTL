...
# with minor changes by Ioannis Athanasiadis
...
from utils.util import mass_iou as iou
...
tf.app.flags.DEFINE_string('data_dir', '', 'Location of root directory for the '
                           ...
                           '(images).')
tf.app.flags.DEFINE_string('output_path', '/media/terabyte/projects/datasets/kitti', 'Path to which TFRecord files'
...
tf.app.flags.DEFINE_string('classes_to_use', 'car,pedestrian,cyclist',
...
tf.app.flags.DEFINE_string('label_map_path', '%s/kitti_label_map.pbtxt' % os.path.dirname(__file__),
                           'Path to label map proto.')
tf.app.flags.DEFINE_integer('validation_set_size', '200', 'Number of images to'
